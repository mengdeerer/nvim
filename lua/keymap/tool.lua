...
local mappings = {
	plugins = {
		...
		--- Plugin: CopilotChat
		["nv|<leader>cc"] = map_cr("CopilotChatToggle")
			:with_noremap()
			:with_silent()
			:with_desc("tool: Toggle CopilotChat"),
		["nv|<leader>ck"] = map_cu("CopilotChatExplain")
			:with_noremap()
			:with_silent()
			:with_desc("tool: CopilotChat Explain"),
		["v|<leader>ca"] = map_cu("CopilotChat")
			:with_noremap()
			:with_silent()
			:with_desc("tool: Add selection to CopilotChat"),
	},
}
